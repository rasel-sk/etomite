...
<div class="subTitle">
  <span class="floatRight"><img src="media/images/_tx_.gif" width="1" height="5"><br />
    <?php echo $site_name ;?> - <?php echo $_lang['search']; ?>
  </span>
</div>
...
<table width="100%" border="0">
  ...
  <tr>
    <td colspan="4">
        <input type="submit" value="<?php echo  $_lang['search']; ?>" name="submitok" />
        <input type="button" value="<?php echo  $_lang['cancel']; ?>" name="cancel" onclick="document.location.href='index.php?a=2';" />
  </td>
  </tr>
</table>
