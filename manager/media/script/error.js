...
function doError(msg,url,ln) {
  ...
  str += '</table>'
  str += '</div>'
  str += '<p style="margin-bottom: 5;">Please report this in the Etomite <a href="http://www.etomite.com/forums" target="_blank">Bug tracker</a>.</p>'
  ...
  str += '</td></tr></table><p>If no error information is showing, please try to reproduce the error using Microsoft Internet Explorer.</p>'
  str += '</body>'
