 ...
 * @version    2.0 BETA 2 (Revision: 211, Date: 2008/05/12 02:48:48)
 * @package    Texy
 * @link       http://texy.info/
 */

define('TEXY_VERSION','2.0 BETA 2 (Revision: 211, Date: 2008/05/12 02:48:48)');if(function_exists('mb_get_info')){if(mb_get_info('func_overload')&2&&substr(mb_get_info('internal_encoding'),0,1)==='U'){mb_internal_encoding('pass');trigger_error("Texy: mb_internal_encoding changed to 'pass'",E_USER_WARNING);}}if(ini_get('zend.ze1_compatibility_mode')%
256||preg_match('#on$|true$|yes$#iA',ini_get('zend.ze1_compatibility_mode'))){throw
new
RuntimeException("Texy cannot run with zend.ze1_compatibility_mode enabled.");}if(!class_exists('Object',FALSE)){abstract
class
Object{final
public
function
...
TexyModifier
extends
Object{public$id;public$classes=array();public$styles=array();public$attrs=array();public$hAlign;public$vAlign;public$title;public$cite;public
...
TexyModule
extends
Object{protected$texy;}class
TexyParser
extends
Object{protected$texy;protected$element;public$patterns;public
function
...
extends
Object{private$handlers;private$pos;private$args;private$parser;public
function
...
FALSE;$tx->summary['links'][]=$elAttrs['href'];}}$el->validateAttrs($tx->dtd);return$el;}public
function
...
TexyImage
extends
Object{public$URL;public$overURL;public$linkedURL;public$width;public$height;public$asMax;public$modifier;public$name;public
function
...
function
beforeParse($texy,&$text){self::$livelock=array();if($texy->allowed['link/definition']){$text=preg_replace_callback('#^\[([^\[\]\#\?\*\n]+)\]: +(\S+)(\ .+)?'.TEXY_MODIFIER.'?\s*()$#mUu',array($this,'patternReferenceDef'),$text);}}private
function
...
extends
TexyModule{public$indent=TRUE;public$baseIndent=0;public$lineWrap=80;public$removeOptional=TRUE;private$space;private$tagUsed;private$tagStack;private$baseDTD;private$xml;public
function
