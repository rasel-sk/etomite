// RTE
// Snippet to create a Rich Text Editor in a form
...
// Notes:
//      You do not need to create a textarea as the snippet creates one.
...
// if the rte text area variable has been assigned, use it, otherwise use rte1
$rte = isset($rte) ? $rte : "rte1";

// specify the path to the rte directory
$path = "./manager/media/rte/";

//format content for preloading
if(!(isset($_POST[$rte]))) $content = $_POST[$rte];
if(isset($value)) $content = $value;
